...
public class OrderTimeStampExtractor implements TimestampExtractor {
    ...
    public long extract(ConsumerRecord<Object, Object> record, long partitionTime) {
		...
		/*
		 * if(orderRecord!=null && orderRecord.orderedDateTime()!=null){ var timeStamp =
		 * orderRecord.orderedDateTime(); log.info("TimeStamp in extractor : {} ",
		 * timeStamp); return convertToInstantUTCFromCST(timeStamp); }
		 */
